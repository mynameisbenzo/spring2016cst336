<?php
    ...
    $player_Image =["<img src=\"/Lab%203/assets/players/Punisher.jpg\" height=\"96\" width=\"72\">", 
                  "<img src=\"/Lab%203/assets/players/DareDevilLogo.jpg\" height=\"96\" width=\"72\">",
                  "<img src=\"/Lab%203/assets/players/Mystery.png\" height=\"96\" width=\"72\">",
                  "<img src=\"/Lab%203/assets/players/suspicious_person.jpg\" height=\"96\" width=\"72\">"];
        ...
        //  echo "<td>".$player_Hand."</td>";
          if($player_Hand == 4){
            for($i=0; $i<$player_Hand; $i++){
              for($j=1; $j<14; $j++){
                if($deck[$i] == "Club".$j){
                    echo "<td><img src=\"/Lab%203/assets/clubs/$j.png\"></td>";
                    if("Club".$j == "Club1"){
                        $p1_score += 1;
                    }
                    if("Club".$j == "Club2"){
                ...
                if($deck[$i] == "Heart".$j){
                    echo "<td><img src=\"/Lab%203/assets/hearts/$j.png\"></td>";
                    if("Heart".$j == "Heart1"){
                        $p1_score += 1;
                    }
                    if("Heart".$j == "Heart2"){
                ...
                if($deck[$i] == "Diamond".$j){
                    echo "<td><img src=\"/Lab%203/assets/diamonds/$j.png\"></td>";
                ...
                if($deck[$i] == "Spade".$j){
                    echo "<td><img src=\"/Lab%203/assets/spades/$j.png\"></td>";
                    if("Spade".$j == "Spade1"){
                        $p1_score += 1;
                    }
                    if("Spade".$j == "Spade2"){
...
<center><a href="https://lumicao-cst336-jaylum93.c9users.io/Lab%203/SilverJack.php">Play Again?</a></center>
</body>
